...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:`pwd`/external/caffe_dev_MemLayerWithMat/build/lib/
${CODE_PATH}/computeFeatures.bin \
    ...
    -l pool5 \
    -o /home/rgirdhar/data/Work/Datasets/processed/0001_PALn1KDistractor/features/CNN_pool5\
